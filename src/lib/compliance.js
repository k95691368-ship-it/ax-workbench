...
// 어미가 문제였다: 목록이 '아닙니다'로만 끝나 있어서, 라벨 표기형('…의약품이 아님')과
// 문장 연결형('…의약품이 아니며, 균형 잡힌 식생활…')이 허용 구간에 걸리지 않았다.
// 그 결과 법정 필수 표기가 '질병·예방·치료' high 위반 3건으로 잡히고, 위반 수정 버튼이
// AI에게 그 문구를 지우라고 지시했다 — 아래 주석이 경고한 "정반대 사고"가 실제로 가능했다.
export const ALLOWED_PHRASES = [
  '질병의 예방 및 치료를 위한 의약품이 아닙니다',
  '질병의 예방·치료를 위한 의약품이 아닙니다',
  '질병의 예방 및 치료를 위한 의약품이 아님',
  '질병의 예방·치료를 위한 의약품이 아님',
  '질병의 예방 및 치료를 위한 의약품이 아니며',
  '질병의 예방·치료를 위한 의약품이 아니며',
  '의약품이 아닙니다',
  '의약품이 아님',
  '의약품이 아니며',
  '치료를 대신할 수 없습니다',
